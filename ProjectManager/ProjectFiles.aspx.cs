...
namespace ProjectManager
{
    public partial class ProjectFiles : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            rpt.DataSource = DAL.ProjectFilesRule.GetList(id);
            rpt.DataBind();
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (upFilePath.HasFile)
            {
                ...
                DAL.ProjectFilesRule.Add(id, filename, filepath);
                BindData();
            }
        }
        ...
        protected void btnDownLoad_Command(object sender, CommandEventArgs e)
        {
            ...
            var o = DAL.ProjectFilesRule.Get(id);
        ...
        {
            int id = Common.St.ToInt32(e.CommandArgument);
            DAL.ProjectFilesRule.Delete(id);
            BindData();
        }
